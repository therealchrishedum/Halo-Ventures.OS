...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .value{background:var(--white);padding:44px 36px;}
    ...
    <div class="values">
      ...
      <div class="value reveal">
        ...
        <ul>
          ...
          <li>We pursue excellence relentlessly.</li>
          <li>We believe in potential and deliver results.</li>
          <li><b>Brick by brick. Rain or shine.</b></li>
        </ul>
      </div>
      <div class="value reveal">
        <h3>Community</h3>
